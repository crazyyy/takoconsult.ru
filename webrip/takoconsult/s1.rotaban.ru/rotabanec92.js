        ...
        for (var cl = function (cl) {
            for (var n = !!document.getElementsByClassName, ret = [], els = n ? document.getElementsByClassName(cl) : document.getElementsByTagName('*'), p = n ? false : new RegExp('(^|\\s)' + cl + '(\\s|$)'), i = 0; i < els.length; i++)
                if (!p || p.test(els[i].className))
                    ret.push(els[i]);try {if (ret.length > 0) _rotaban.f1b = ret[ret.length - 1];} catch(err){};
            return ret
...
if (_rotaban.vis == 0) 
{
var _acic1 = { 'dataProvider': 150 }; 
(function () { var aci = document.createElement('script'); aci.type = 'text/javascript'; 
aci.async = true; 
aci.src = _rotaban.tracker('stat.html', '', '', '', '', ''); 
_rotaban.f1b.parentNode.insertBefore(aci, _rotaban.f1b); })();
} 
_rotaban.vis = 1;
    }
};
...
_acic = { 'dataProvider': 150 }; (function() { var aci = document.createElement('script'); aci.type = 'text/javascript'; aci.async = true; aci.src = _rotaban.tracker('stat.html', '', '', '', '', ''); var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(aci, s); })();
